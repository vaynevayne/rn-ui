...
import { randomId } from "@repo/hooks";
...
export default function Page() {
    return (<main className={styles.main}>
      <div className={styles.description}>
        ...
        <div>
          <a href="https://vercel.com?utm_source=create-turbo&utm_medium=basic&utm_campaign=create-turbo" rel="noopener noreferrer" target="_blank">
            By{" "}
      ...
      <div className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <div className={styles.turborepoWordmarkContainer}>
            <svg className={styles.turborepoWordmark} viewBox="0 0 506 50" width={200} xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={styles.grid}>
        {LINKS.map(({ title, href, description }) => (<Card className={styles.card} href={href} key={title} title={title}>
            {description}
          </Card>))}
      </div>
    </main>);
